  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="w-screen h-screen z-0 absolute">
        <img src={bgImg} alt="background log in" className="w-screen h-screen" />
      </div>
      <div className="bg-[#fff] w-[42rem] h-[47rem] rounded-3xl flex  items-center flex-col z-20 py-10">
        <div className="font-bold text-4xl mb-5">Đăng Nhập</div>

        <div>
          <span className="text-[#7c7c7c]"> Bạn chưa có tài khoản? </span>
          <span>
            <Link to="/signUp" className="font-semibold border-b border-b-[#000] my-2">
              ĐĂNG KÍ
            </Link>
          </span>
        </div>
        ...
        <div className="my-5 w-full px-8 ">
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-4">
            ...
            <button className="w-full font-semibold">
              <div className="border-b border-b-black w-fit mt-2">Quên mật khẩu?</div>
            </button>
            <button
              type="submit"
              className="w-full rounded-2xl bg-[#5c9f0f] font-semibold text-[#fff] h-16 mt-4 hover:opacity-60 transition-all"
            >
              Đăng Nhập
            </button>
          </form>
        ...
        <div className="grid grid-cols-4">
          <div className="px-10 hover:-translate-y-1 transition-all mx-2 border border-[#676767] rounded-3xl flex justify-center items-center py-2 mt-5">
